#!/usr/bin/python
"CS244 2023  Advance Computer Network Assignment 1: Bufferbloat on Mininet"
...
import os
import math
import numpy as np ##imported numpy to find standard deviation , mean , web download time etc.
...
class BBTopo(Topo):
    ...
    def build(self, n=2):
        ...
        # Link from h1 to router. 1Gbs with 6ms delay.
        delay = args.delay
